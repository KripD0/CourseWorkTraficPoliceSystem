...
public class ViolatonController {
    ...
    private int update() throws SQLException, IOException {
        ...
        if (violationField.getText().isEmpty() || violationField.getText().replace(" ", "").equals("")) {
        ...
        if (DeleteAndEditController.needDelete) {
            String updateBrand = "UPDATE violation SET name = ? WHERE id = ?";
    ...
    private void findByString() throws SQLException{
        ...
        String getTableBrands = "SELECT * FROM violation WHERE name LIKE ? ORDER BY id";
        String finalString;
    ...
    private void loadTable() throws SQLException {
        ...
        String getTableBrands = "SELECT * FROM violation ORDER BY id";
        PreparedStatement preparedStatement = connection.prepareStatement(getTableBrands);
        ResultSet resultSet = preparedStatement.executeQuery();
        idColumn.setCellValueFactory(new PropertyValueFactory<>("id"));
        violationColumn.setCellValueFactory(new PropertyValueFactory<>("name"));
