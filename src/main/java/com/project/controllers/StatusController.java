...
public class StatusController {
    ...
    @FXML
    private TableColumn<Violation, String> statusColumn;

    @FXML
    private TableView<Violation> statusTable;
    ...
    private int delete() throws SQLException, IOException {
        ...
        if (DeleteAndEditController.needDelete) {
            String deleteBrand = "DELETE FROM status WHERE id = ?";
    ...
    private int update() throws SQLException, IOException {
        ...
        if (DeleteAndEditController.needDelete) {
            String updateBrand = "UPDATE status SET name = ? WHERE id = ?";
    ...
    private void findByString() throws SQLException{
        ...
        String getTableBrands = "SELECT * FROM status WHERE name LIKE ? ORDER BY id";
        String finalString;
    ...
    private void loadTable() throws SQLException {
        ...
        String getTableBrands = "SELECT * FROM status ORDER BY id";
        PreparedStatement preparedStatement = connection.prepareStatement(getTableBrands);
        ResultSet resultSet = preparedStatement.executeQuery();
        idColumn.setCellValueFactory(new PropertyValueFactory<>("id"));
        statusColumn.setCellValueFactory(new PropertyValueFactory<>("name"));
        ...
        statusTable.setItems(listViolation);
    }
}
